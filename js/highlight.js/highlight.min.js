...
BACKSLASH_ESCAPE:O,APOS_STRING_MODE:x,QUOTE_STRING_MODE:k,PHRASAL_WORDS_MODE:{
...
const J=a,Y=i,ee=Symbol("nomatch"),ne=n=>{
...
i=e,a=n),void 0===t&&(t=!0);const r={code:a,language:i};k("before:highlight",r)
;const s=r.result?r.result:f(r.language,r.code,t)
;return s.code=r.code,k("after:highlight",s),s}function f(e,n,i,r){
const l=Object.create(null);function c(){if(!x.keywords)return void M.addText(S)
...
;e=f(x.subLanguage,S,!0,k[x.subLanguage]),k[x.subLanguage]=e._top
...
;const N=Q(w);let O="",x=r||N;const k={},M=new d.__emitter(d);(()=>{const e=[]
...
language:e,value:O,relevance:A,illegal:!1,_emitter:M,_top:x}}catch(t){
...
}),k("after:highlightElement",{el:e,result:r,text:a})}let w=!1;function N(){
"loading"!==document.readyState?document.querySelectorAll(d.cssSelector).forEach(y):w=!0
}function v(e){return e=(e||"").toLowerCase(),a[e]||a[i[e]]}
function O(e,{languageName:n}){"string"==typeof e&&(e=[e]),e.forEach((e=>{
i[e.toLowerCase()]=n}))}function x(e){const n=v(e)
;return n&&!n.disableAutodetect}function k(e,n){const t=e;r.forEach((e=>{
e[t]&&e[t](n)}))}
...
removePlugin:e=>{const n=r.indexOf(e);-1!==n&&r.splice(n,1)}}),n.debugMode=()=>{
s=!1},n.safeMode=()=>{s=!0},n.versionString="11.7.0",n.regex={concat:m,
lookahead:g,either:p,optional:b,anyNumberOfTimes:u}
;for(const n in T)"object"==typeof T[n]&&e.exports(T[n])
;return Object.assign(n,T),n},te=ne({});te.newInstance=()=>ne({});const ae=e=>({
...
contains:[e.BACKSLASH_ESCAPE,l],subLanguage:"css"}},g={begin:"gql`",end:"",
...
},m=[e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,c,d,g,u,{match:/\$\d+/},o]
;l.contains=m.concat({begin:/\{/,end:/\}/,keywords:i,contains:["self"].concat(m)
});const p=[].concat(b,l.contains),_=p.concat([{begin:/\(/,end:/\)/,keywords:i,
contains:["self"].concat(p)}]),h={className:"params",begin:/\(/,end:/\)/,
excludeBegin:!0,excludeEnd:!0,keywords:i,contains:_},f={variants:[{
match:[/class/,/\s+/,t,/\s+/,/extends/,/\s+/,n.concat(t,"(",n.concat(/\./,t),")*")],
scope:{1:"keyword",3:"title.class",5:"keyword",7:"title.class.inherited"}},{
match:[/class/,/\s+/,t],scope:{1:"keyword",3:"title.class"}}]},E={relevance:0,
match:n.either(/\bJSON/,/\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/,/\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/,/\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/),
className:"title.class",keywords:{_:[...he,...fe]}},y={variants:[{
match:[/function/,/\s+/,t,/(?=\s*\()/]},{match:[/function/,/\s*(?=\()/]}],
className:{1:"keyword",3:"title.function"},label:"func.def",contains:[h],
illegal:/%/},w={
match:n.concat(/\b/,(N=[...Ee,"super","import"],n.concat("(?!",N.join("|"),")")),t,n.lookahead(/\(/)),
...
},e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,c,d,g,u,b,{match:/\$\d+/},o,E,{
...
excludeEnd:!0,keywords:i,contains:_}]}]},{begin:/,/,relevance:0},{match:/\s+/,
...
const ve=e=>m(/\b/,e,/\w$/.test(e)?/\b/:/\B/),Oe=["Protocol","Type"].map(ve),xe=["init","self"].map(ve),ke=["Any","Self"],Me=["actor","any","associatedtype","async","await",/as\?/,/as!/,"as","break","case","catch","class","continue","convenience","default","defer","deinit","didSet","distributed","do","dynamic","else","enum","extension","fallthrough",/fileprivate\(set\)/,"fileprivate","final","for","func","get","guard","if","import","indirect","infix",/init\?/,/init!/,"inout",/internal\(set\)/,"internal","in","is","isolated","nonisolated","lazy","let","mutating","nonmutating",/open\(set\)/,"open","operator","optional","override","postfix","precedencegroup","prefix",/private\(set\)/,"private","protocol",/public\(set\)/,"public","repeat","required","rethrows","return","set","some","static","struct","subscript","super","switch","throws","throw",/try\?/,/try!/,"try","typealias",/unowned\(safe\)/,/unowned\(unsafe\)/,"unowned","var","weak","where","while","willSet"],Se=["false","nil","true"],Ae=["assignment","associativity","higherThan","left","lowerThan","none","right"],Ce=["#colorLiteral","#column","#dsohandle","#else","#elseif","#endif","#error","#file","#fileID","#fileLiteral","#filePath","#function","#if","#imageLiteral","#keyPath","#line","#selector","#sourceLocation","#warn_unqualified_access","#warning"],Te=["abs","all","any","assert","assertionFailure","debugPrint","dump","fatalError","getVaList","isKnownUniquelyReferenced","max","min","numericCast","pointwiseMax","pointwiseMin","precondition","preconditionFailure","print","readLine","repeatElement","sequence","stride","swap","swift_unboxFromSwiftValueWithType","transcode","type","unsafeBitCast","unsafeDowncast","withExtendedLifetime","withUnsafeMutablePointer","withUnsafePointer","withVaList","withoutActuallyEscaping","zip"],Re=p(/[/=\-+!*%<>&|^~?]/,/[\u00A1-\u00A7]/,/[\u00A9\u00AB]/,/[\u00AC\u00AE]/,/[\u00B0\u00B1]/,/[\u00B6\u00BB\u00BF\u00D7\u00F7]/,/[\u2016-\u2017]/,/[\u2020-\u2027]/,/[\u2030-\u203E]/,/[\u2041-\u2053]/,/[\u2055-\u205E]/,/[\u2190-\u23FF]/,/[\u2500-\u2775]/,/[\u2794-\u2BFF]/,/[\u2E00-\u2E7F]/,/[\u3001-\u3003]/,/[\u3008-\u3020]/,/[\u3030]/),De=p(Re,/[\u0300-\u036F]/,/[\u1DC0-\u1DFF]/,/[\u20D0-\u20FF]/,/[\uFE00-\uFE0F]/,/[\uFE20-\uFE2F]/),Ie=m(Re,De,"*"),Le=p(/[a-zA-Z_]/,/[\u00A8\u00AA\u00AD\u00AF\u00B2-\u00B5\u00B7-\u00BA]/,/[\u00BC-\u00BE\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u00FF]/,/[\u0100-\u02FF\u0370-\u167F\u1681-\u180D\u180F-\u1DBF]/,/[\u1E00-\u1FFF]/,/[\u200B-\u200D\u202A-\u202E\u203F-\u2040\u2054\u2060-\u206F]/,/[\u2070-\u20CF\u2100-\u218F\u2460-\u24FF\u2776-\u2793]/,/[\u2C00-\u2DFF\u2E80-\u2FFF]/,/[\u3004-\u3007\u3021-\u302F\u3031-\u303F\u3040-\uD7FF]/,/[\uF900-\uFD3D\uFD40-\uFDCF\uFDF0-\uFE1F\uFE30-\uFE44]/,/[\uFE47-\uFEFE\uFF00-\uFFFD]/),Be=p(Le,/\d/,/[\u0300-\u036F\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F]/),$e=m(Le,Be,"*"),ze=m(/[A-Z]/,Be,"*"),Fe=["autoclosure",m(/convention\(/,p("swift","block","c"),/\)/),"discardableResult","dynamicCallable","dynamicMemberLookup","escaping","frozen","GKInspectable","IBAction","IBDesignable","IBInspectable","IBOutlet","IBSegueAction","inlinable","main","nonobjc","NSApplicationMain","NSCopying","NSManaged",m(/objc\(/,$e,/\)/),"objc","objcMembers","propertyWrapper","requires_stored_property_inits","resultBuilder","testable","UIApplicationMain","unknown","usableFromInline"],Ue=["iOS","iOSApplicationExtension","macOS","macOSApplicationExtension","macCatalyst","macCatalystApplicationExtension","watchOS","watchOSApplicationExtension","tvOS","tvOSApplicationExtension","swift"]
;var je=Object.freeze({__proto__:null,grmr_bash:e=>{const n=e.regex,t={},a={
...
const n=ae(e),t=ce,a="([\\w-]+|@\\{[\\w-]+\\})",i=[],r=[],s=e=>({
className:"string",begin:"~?"+e+".*?"+e}),o=(e,n,t)=>({className:e,begin:n,
relevance:t}),l={$pattern:/[a-z-]+/,keyword:"and or not only",
attribute:re.join(" ")},c={begin:"\\(",end:"\\)",contains:r,keywords:l,
relevance:0}
...
contains:["self"]}),a=[e.C_LINE_COMMENT_MODE,t],i={match:[/\./,p(...Oe,...xe)],
className:{2:"keyword"}},r={match:m(/\./,p(...Me)),relevance:0
},s=Me.filter((e=>"string"==typeof e)).concat(["_|0"]),o={variants:[{
className:"keyword",
match:p(...Me.filter((e=>"string"!=typeof e)).concat(ke).map(ve),...xe)}]},l={
$pattern:p(/\b\w+/,/#\w+/),keyword:s.concat(Ce),literal:Se},c=[i,r,o],d=[{
match:m(/\./,p(...Te)),relevance:0},{className:"built_in",
match:m(/\b/,p(...Te),/(?=\()/)}],u={match:/->/,relevance:0},b=[u,{
...
match:m(/`/,$e,/`/)},x=[O,{className:"variable",match:/\$\d+/},{
className:"variable",match:`\\$${Be}+`}],k=[{match:/(@|#(un)?)available/,
className:"keyword",starts:{contains:[{begin:/\(/,end:/\)/,keywords:Ue,
contains:[...b,h,v]}]}},{className:"keyword",match:m(/@/,p(...Fe))},{
className:"meta",match:m(/@/,$e)}],M={match:g(/\b[A-Z]/),relevance:0,contains:[{
className:"type",
match:m(/(AV|CA|CF|CG|CI|CL|CM|CN|CT|MK|MP|MTK|MTL|NS|SCN|SK|UI|WK|XC)/,Be,"+")
},{className:"type",match:ze,relevance:0},{match:/[?!]+/,relevance:0},{
match:/\.\.\./,relevance:0},{match:m(/\s+&\s+/,g(ze)),relevance:0}]},S={
begin:/</,end:/>/,keywords:l,contains:[...a,...c,...k,u,M]};M.contains.push(S)
;const A={begin:/\(/,end:/\)/,relevance:0,keywords:l,contains:["self",{
match:m($e,/\s*:/),keywords:"_|0",relevance:0
},...a,...c,...d,...b,h,v,...x,...k,M]},C={begin:/</,end:/>/,contains:[...a,M]
},T={begin:/\(/,end:/\)/,keywords:l,contains:[{
begin:p(g(m($e,/\s*:/)),g(m($e,/\s+/,$e,/\s*:/))),end:/:/,relevance:0,
contains:[{className:"keyword",match:/\b_\b/},{className:"params",match:$e}]
},...a,...c,...b,h,v,...k,M,A],endsParent:!0,illegal:/["']/},R={
match:[/func/,/\s+/,p(O.match,$e,Ie)],className:{1:"keyword",3:"title.function"
},contains:[C,T,n],illegal:[/\[/,/%/]},D={
match:[/\b(?:subscript|init[?!]?)/,/\s*(?=[<(])/],className:{1:"keyword"},
contains:[C,T,n],illegal:/\[|%/},I={match:[/operator/,/\s+/,Ie],className:{
1:"keyword",3:"title"}},L={begin:[/precedencegroup/,/\s+/,ze],className:{
1:"keyword",3:"title"},contains:[M],keywords:[...Ae,...Se],end:/}/}
...
},...c,...d,...b,h,v,...x,...k,M,A]}},grmr_typescript:e=>{
const n=Ne(e),t=["any","void","number","boolean","string","object","never","symbol","bigint","unknown"],a={
beginKeywords:"namespace",end:/\{/,excludeEnd:!0,
contains:[n.exports.CLASS_REFERENCE]},i={beginKeywords:"interface",end:/\{/,
excludeEnd:!0,keywords:{keyword:"interface extends",built_in:t},
contains:[n.exports.CLASS_REFERENCE]},r={$pattern:me,
keyword:pe.concat(["type","namespace","interface","public","private","protected","implements","declare","abstract","readonly","enum","override"]),
literal:_e,built_in:we.concat(t),"variable.language":ye},s={className:"meta",
...
aliases:["yml"],contains:l}}});const Pe=te;for(const e of Object.keys(je)){
const n=e.replace("grmr_","").replace("_","-");Pe.registerLanguage(n,je[e])}
return Pe}()
